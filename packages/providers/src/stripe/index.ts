...
import { generatedStripeEvents, type StripeEventType } from "./_generated-events";
...
const curatedEvents: Partial<Record<StripeEventType, string | EventDefinition>> = {
...
export const stripe = defineProvider({
  ...
  // Merge: auto-generated base (260 events) + hand-curated overrides
  events: { ...generatedStripeEvents, ...curatedEvents } as Record<
    StripeEventType,
